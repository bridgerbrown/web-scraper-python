...
if [[ ! -d $STORAGE_DIR/chrome ]]; then
  ...
  if [[ "$(uname -s)" == "Darwin" ]]; then
    if [[ "$(uname -m)" == "x86_64" ]]; then
      ...
      wget -P ./ https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/117.0.5938.62/mac-arm64/chromedriver-mac-arm64.zip
      unzip -o ./chromedriver-mac-arm64.zip -d $STORAGE_DIR/chrome/
